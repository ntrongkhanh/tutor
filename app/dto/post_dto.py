...
class PostDto:
    ...
    filter_parser.add_argument("latitude", type=float, location="args", required=False)
    filter_parser.add_argument("longitude", type=float, location="args", required=False)
