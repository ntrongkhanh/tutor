...
class PostDto:
    ...
    create_parser.add_argument("point_address", type=str, location="json", required=False)
    ...
    update_parser.add_argument("point_address", type=str, location="json", required=False)
    ...
    filter_parser.add_argument("point_address", type=str, location="args", required=False)
