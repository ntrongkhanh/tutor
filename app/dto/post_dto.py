...
class PostDto:
    ...
    create_parser.add_argument("latitude", type=str, location="json", required=False)
    create_parser.add_argument("longitude", type=str, location="json", required=False)
    ...
    update_parser.add_argument("latitude", type=str, location="json", required=False)
    update_parser.add_argument("longitude", type=str, location="json", required=False)
    ...
    filter_parser.add_argument("latitude", type=str, location="args", required=False)
    filter_parser.add_argument("longitude", type=str, location="args", required=False)
